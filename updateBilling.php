...
$sql = "update billing set id=$id,first_name='$fname',last_name='$lname',course='$course',tuition_fees='$tuitionFees',registration_fees='$registration',hostel_fees='$hostelFees',library_fees='$libraryFees' where id=$id";
...
<div class="intro" style="text-align: center; margin-top: 2em; margin-bottom: 2em;">
 <h1 class="text-center">update Billing Information details</h1>
</div>
  ...
  <button type="submit" name="submit" class="btn btn-primary">Update Billing</button>
  &nbsp;
  &nbsp;
  <a href="billing.php" class="btn btn-success">Add new new billing</a>
  &nbsp;
  &nbsp;
  <a href="displayBilling.php" class="btn btn-danger">Delete existing billing</a>
  &nbsp;
  &nbsp;
</form>
