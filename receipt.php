...
$sql = "insert into receipt (first_name,last_name, course, tuition_fees, registration_fees, hostel_fees, library_fees,amount_paid)
values('$fname', '$lname', '$course', '$tuitionFees', '$registrationFees', '$hostelFees', '$libraryFees','$amountPaid')";
...
<div class="intro" style="text-align: center; margin-top: 2em; margin-bottom: 2em;">
  <h1 class="text-center">Add receipt information details</h1>
</div>
  ...
  <div class="mb-3">
    ...
    <input type="number" name="tuitionFees" class="form-control" id="tuitionFees" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="registrationFees" class="form-label">REGISTRATION FEES</label>
    <input type="number" name="registrationFees" class="form-control" id="registrationFees" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="hostelFees" class="form-label">HOSTEL FEES</label>
    <input type="number" name="hostelFees" class="form-control" id="hostelFees" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="libraryFees" class="form-label">LIBRARY FEES</label>
    <input type="number" name="libraryFees" class="form-control" id="libraryFees" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="amountPaid" class="form-label">AMOUNT PAID</label>
    <input type="number" name="amountPaid" class="form-control" id="amountPaid" aria-describedby="emailHelp">
  </div>
  ...
  &nbsp;
  &nbsp;
  <a href="displayReceipt.php" class="btn btn-primary">view receipt report</a>
</form>
...
<div class="container">
  ...
  <h4 style="padding-top: 40px; padding-bottom: 50px; color: lightblue;" class="text-center">
      ...
      <a href="#" target="_black">Angelo MD</a>
  </h4>
</div>    
</footer>
