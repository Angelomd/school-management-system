...
$sql = "insert into stuffs (first_name, middle_name, last_name, gender, position, department, join_date)
values('$fname', '$mname', '$lname', '$gender', '$position', '$department', '$join_date')";
...
<div class="intro" style="text-align: center; margin-top: 2em; margin-bottom: 2em;">
  <h1 class="text-center">Add staff's details</h1>
</div>
  ...
  <!-- <div class="mb-3">
    ...
    <input type="localtime" name="join_date" class="form-control" id="join_date">
  </div>
  -->
  ...
  &nbsp;
  &nbsp;
  <a href="displayStuff.php" class="btn btn-primary">view staff report</a>
</form>
