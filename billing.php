...
$sql = "insert into billing (first_name,last_name, course, tuition_fees, registration_fees, hostel_fees, library_fees)
values('$fname', '$lname', '$course', '$tuitionFees', '$registrationFees', '$hostelFees', '$libraryFees')";
...
<div class="intro" style="text-align: center; margin-top: 2em; margin-bottom: 2em;">
  <h1 class="text-center">Add Billing details</h1>
</div>
  ...
  &nbsp;
  &nbsp;
  <a href="displayBilling.php" class="btn btn-primary">view billing report</a>
</form>
