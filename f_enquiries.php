...
$sql = "insert into enquiries (first_name, other_name, phone, email, course, hdyku,comment)
values('$fname', '$oname', '$phone', '$email', '$course', '$hdyku','$comment')";

$result = mysqli_query($cons,$sql);
if($result){
//  header('location:displayEnquiries.php');
echo "new Enquiries added successfully";
...
<nav class="navbar navbar-expand-sm bg-primary navbar-fixed-top navbar-dark">
  ...
  <li class="nav-item">
        <a class="nav-link" href="f_enquiries.php">ENQUIRIES</a>
      </li>
  <li class="nav-item">
        <a class="nav-link" href="f_registration.php">REGISTRATION</a>
      </li>
...
<div class="intro" style="text-align: center; margin-top: 2em; margin-bottom: 2em;">
  <h1 class="text-center">Add a new enquiry</h1>
</div>
  ...
  <div class="mb-3">
   ...
   <select name="hdyku" class="form-control" id="user_group">
  ...
  <div class="mb-3">
    <label for="course" class="form-label">LEAVE A COMMENT</label>
  ...
  &nbsp;
  &nbsp;
  <!-- <a href="displayEnquiries.php" class="btn btn-primary">view enquiries report</a> -->
</form>
